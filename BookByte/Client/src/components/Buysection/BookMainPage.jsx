...
//         {/* Top Section: Image, Book Name, Author */}
...
//         {/* Main Section: Details and Buy Card */}
//         <div className="flex flex-col lg:flex-row gap-12">
//           {/* Left Section: Description, Publisher, ISBN */}
...
//             </p>
//             <div className="mb-6">
//               <label htmlFor="quantity" className="block text-sm font-medium text-gray-500 mb-2">
//                 Quantity
//               </label>
//               <input
//                 type="number"
...
//                 min="1"
//                 max="10"
//                 className="w-full p-3 bg-gray-50 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:outline-none"
//               />
//             </div>
//             <div className="flex flex-col gap-4">
//               <button className="w-full bg-indigo-600 text-white py-3 rounded-lg shadow-md hover:bg-indigo-700 transition duration-200">
//                 Buy Now
//               </button>
//               <button className="w-full bg-gray-200 text-gray-700 py-3 rounded-lg shadow-md hover:bg-gray-300 transition duration-200">
//                 Add to Cart
//               </button>
//             </div>
//           </div>
...
//   // State to toggle the order form
